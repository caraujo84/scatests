...
class HomePage():
    ...
    first_image = (
        By.XPATH, '/html/body/main/div[1]/div/div/div[2]/div/picture/img')
    learn_more_btn = (
        By.XPATH, '/html/body/main/div[1]/div/div/div[1]/div/div/div[3]/a')
    conteiner_recomended_products = (
        By.XPATH, '/html/body/main/div[2]/div/div[2]/div')
    personal_btn = (By.XPATH, '//*[@id="tab-204"]')
    business_btn = (By.XPATH, '//*[@id="tab-205"]')
    container_blog_articles = (By.XPATH, '//*[@id="panel-204"]')
    second_image = (
        By.XPATH, '/html/body/main/div[4]/div/div[2]/div/picture/img')
    ...
    third_image = (
        By.XPATH, '/html/body/main/div[5]/div/div[2]/div[1]/picture/img')
