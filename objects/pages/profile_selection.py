...
class ProfileSelection():
    ...
    profile_selection_modal = (By.XPATH, '/html/body/main/dialog[1]')
    employee_status = (By.ID, 'employee-status-id')
    annual_income_select = (By.ID, 'annual-income-id')
    phone_number_input = (By.ID, 'phone-number-id')
    children_radio_buttons = (
        By.XPATH, '/html/body/main/dialog[1]/div/form/div[4]/div/div')
    homeowner_radio_buttons = (
        By.XPATH, '/html/body/main/dialog[1]/div/form/div[5]/div/div')
    ...
    choose_profile_btn = (
        By.XPATH, '//*[@id="312"]/div/div[1]/div[1]/div[2]/button[1]')
